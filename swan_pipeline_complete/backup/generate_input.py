...
BOUNDSPEC SIDE EAST CCW VARIABLE FILE 0 'boundary.txt' 1
BOUNDSPEC SIDE SOUTH CCW VARIABLE FILE 0 'boundary.txt' 1
...
COMPUTE NONSTATIONARY {start} {compute_dt_value} {compute_dt_unit} {end}
